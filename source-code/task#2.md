...
- Під час додавання та видалення контакту контакти зберігаються у
  `localStorage`.
- Під час завантаження застосунку todo-листb, якщо такі є, зчитуються з
...
Використовуйте готову структуру форми з попередньго таска
...
Кожена тудушка повиненна бути об'єктом з властивостями `text` та `id`. Для
