...
> ### Завдання з іконкою робити за бажанням. Треба продумати логіку, як динамічно відмалювати з бібліотеки [**react-icons**](https://github.com/react-icons/react-icons) та змінити дефолтний розмір
